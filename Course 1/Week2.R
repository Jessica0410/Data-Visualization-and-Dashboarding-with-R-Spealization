...
trump_survey<- dat |> select(educ,edloan,employ,CC18_308a)
trump_survey
...
trump_survey$trump_approve_disapprove<-trump_approve_disapprove <- 
  trump_survey$CC18_308a|>
  recode('1' = 1, '2' = 1, '3' = 0, '4'=0)
trump_survey
...
dat|>
  ...
  summarize(
    "Mean Importance of Religion" = mean(pew_religimp),
